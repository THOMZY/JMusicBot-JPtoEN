...
public class nicoSearchAPI {
    ...
    public LinkedList<nicoVideoSearchResult> searchVideo(String query, int resultLimit, boolean autogetVideoInfo) {
        ...
        // https://snapshot.search.nicovideo.jp/api/v2/snapshot/video/contents/search?q=Hatsune+Miku&targets=title&fields=contentId,title,viewCounter&filters[viewCounter][gte]=10000&_sort=-viewCounter&_offset=0&_limit=3&_context=apiguide
        // https://snapshot.search.nicovideo.jp/api/v2/snapshot/video/contents/search?q=Hatsune+Miku&_limit=5&_context=discord_bot&fields=contentId,title,description,tags,categoryTags,viewCounter,mylistCounter,commentCounter,startTime,lastCommentTime,lengthSeconds,thumbnailUrl&_sort=-viewCounter&targets=title
